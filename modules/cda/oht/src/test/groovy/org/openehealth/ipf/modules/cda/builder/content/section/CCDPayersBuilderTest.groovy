 ...
 */
public class CCDPayersBuilderTest extends AbstractCDAR2BuilderTest {
	
	
	@Before
	void initialize() throws Exception {
	    new CCDDefinitionLoader(builder).loadPayers(loaded)
		new CCDPayersExtension(builder).register(registered)
	}
