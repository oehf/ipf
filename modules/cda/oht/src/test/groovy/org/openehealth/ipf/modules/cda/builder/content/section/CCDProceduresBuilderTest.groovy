 ...
 */
public class CCDProceduresBuilderTest extends AbstractCDAR2BuilderTest {
	
	@Before
	void initialize() throws Exception {
	    new CCDDefinitionLoader(builder).loadProcedures(loaded)
		new CCDProceduresExtension(builder).register(registered)
	}
	
	@Test
	public void testCCDProcedures() {
		POCDMT000040Section procedures = builder.build(
		        getClass().getResource('/builders/content/section/CCDProceduresExample.groovy'))
		new CCDProceduresValidator().validate(procedures, null)
	}
