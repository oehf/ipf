 ...
 */
public class CCDMainActivityBuilderTest extends AbstractCDAR2BuilderTest {
	
	@Before
	void initialize() throws Exception {
        new CCDDefinitionLoader(builder).loadMainActivity(loaded)
		new CCDMainActivityExtension(builder).register(registered)
	}
