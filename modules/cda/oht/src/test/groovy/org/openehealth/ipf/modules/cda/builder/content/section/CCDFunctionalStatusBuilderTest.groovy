 ...
 */
public class CCDFunctionalStatusBuilderTest extends AbstractCDAR2BuilderTest {
	
	@Before
	void initialize() throws Exception {
        new CCDDefinitionLoader(builder).loadFunctionalStatus(loaded)
        new CCDFunctionalStatusExtension(builder).register(registered)
	}
	
	@Test
	public void testCCDFunctionalStatus() {
		POCDMT000040Section funcStatus = builder.build(
		        getClass().getResource('/builders/content/section/CCDFunctionalStatusExample.groovy'))
		new CCDFunctionalStatusValidator().validate(funcStatus, null)
	}
