 ...
 */
public class CCDProceduresExtension extends CompositeModelExtension {
	
    CCDProceduresExtension() {
		super()
	}
	
    CCDProceduresExtension(builder) {
		super(builder)
	}
	...
	def register(Collection registered) {
        ...
        POCDMT000040ClinicalDocument.metaClass {
            setProcedures { POCDMT000040Section section ->
	...
	Collection modelExtensions() {
        [ new CCDProcedureActivityExtension(),
