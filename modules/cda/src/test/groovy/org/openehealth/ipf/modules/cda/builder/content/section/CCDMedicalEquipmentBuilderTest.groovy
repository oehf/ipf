 ...
 */
public class CCDMedicalEquipmentBuilderTest extends AbstractCDAR2BuilderTest {
	
	@Before
	void initialize() throws Exception {
		new CCDDefinitionLoader(builder).loadMedicalEquipment(loaded)
		new CCDMedicalEquipmentExtension(builder).register(registered)
	}
	
	@Test
	public void testCCDMedicalEquipment() {
		POCDMT000040Section equipment = builder.build(
                getClass().getResource('/builders/content/section/CCDMedicalEquipmentExample.groovy'))
		new CCDMedicalEquipmentValidator().validate(equipment, null)
	}
