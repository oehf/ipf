 ...
 */
public class CCDFamilyHistoryBuilderTest extends AbstractCDAR2BuilderTest {
	
	@Before
	void initialize() throws Exception {
	    new CCDDefinitionLoader(builder).loadFamilyHistory(loaded)
        new CCDFamilyHistoryExtension(builder).register(registered)
	}
