 ...
 */
public class CCDSupportBuilderTest extends AbstractContentBuilderTest {
	
	@BeforeClass
	static void initialize() throws Exception {
		builder().define(getClass().getResource('/builders/content/entry/CCDSupportBuilder.groovy'))
		def extension = new CCDSupportExtension(builder())
