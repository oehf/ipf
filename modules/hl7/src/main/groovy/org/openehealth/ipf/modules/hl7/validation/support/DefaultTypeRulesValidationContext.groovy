...
import org.openehealth.ipf.modules.hl7.validation.builder.DefaultTypeRulesBuilder
import org.openehealth.ipf.modules.hl7.validation.builder.RuleBuilder

/**
 * A validation context that checks all primitive type constraints defined in
...
public class DefaultTypeRulesValidationContext extends DefaultValidationContext{
     ...
     public RuleBuilder configure() {
         new DefaultTypeRulesBuilder().forContext(this)
     }
}
