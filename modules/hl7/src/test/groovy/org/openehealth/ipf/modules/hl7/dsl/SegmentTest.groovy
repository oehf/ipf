...
class SegmentTest extends groovy.test.GroovyAssert {
    ...
    void testPrimitiveGetAt() {
        ...
        // field with value
        assert msh[3] instanceof Primitive
        assert msh[3].value == 'SAP-ISH'

        // field without value
        assert msh[6] instanceof Primitive
        assert !msh[6].value
    }

    @Test
    void testCompositeGetAt() {
        assert nk1[4] instanceof Composite
        assert nk1[4][4] instanceof Primitive
        assert nk1[4][4].value == 'NW'
        assert nk1[4][2] instanceof Primitive
    ...
    void testPrimitiveSetAt() {
        assert msh[5] instanceof Primitive
        assert !msh[5].value
    ...
    void testZeroCardinality() {
        ...
        assert pid[5](0)[1][2] instanceof Primitive
    ...
    void testSettingObx5Type() {
        ...
        ORU_R01 msg = load('dsl/msg-02.hl7')
        Repeatable observations = msg.PATIENT_RESULT.ORDER_OBSERVATION.OBSERVATION()
        OBX obx = observations(observations().size()).OBX
