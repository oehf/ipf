...
rem --------------------------------------------------------
set JAVA_OPTS=-Xmx256m -Dcluster.node.dir=%NODE% -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false
