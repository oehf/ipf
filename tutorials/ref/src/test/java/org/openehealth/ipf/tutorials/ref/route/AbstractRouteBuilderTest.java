...
public abstract class AbstractRouteBuilderTest {
    ...
    public void testOrderAnimals() throws Exception {
        ...
        Exchange exchange1 = (Exchange)producerTemplate.send("direct:order", 
    ...
    public void testOrderBooks() throws Exception {
        ...
        Exchange exchange1 = (Exchange)producerTemplate.send("direct:order", createExchange(
    ...
    public void testErrorApp() throws Exception {
        ...
        Exchange exchange = (Exchange)producerTemplate.send("direct:order", 
    ...
    public void testErrorSys() throws Exception {
        ...
        assertTrue(((String)exchange.getOut().getBody()).contains("SAXParseException"));
        assertTrue(exchange.getException() instanceof RuntimeCamelException);
        assertTrue(exchange.getException().getCause() instanceof SAXParseException);
