...
@EnableConfigurationProperties(IpfSvsConfigurationProperties.class)
public class IpfSvsAutoConfiguration {

    private final IpfSvsConfigurationProperties properties;

    public IpfSvsAutoConfiguration(IpfSvsConfigurationProperties properties) {
    ...
    @ConditionalOnProperty("ipf.svs.observing")
