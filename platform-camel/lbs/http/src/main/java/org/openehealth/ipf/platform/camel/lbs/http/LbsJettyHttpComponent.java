...
public class LbsJettyHttpComponent extends JettyHttpComponent {
	...
	@Override
	protected CamelServlet createServletForConnector(Server server,
			Connector connector, List<Handler> handlers,
	...
	protected Endpoint createEndpoint(String uri, String remaining,
		...
		JettyHttpEndpoint endpoint = (JettyHttpEndpoint) super.createEndpoint(
				uri, remaining, parameters);
		endpoint.setBinding(new LbsHttpBinding(endpoint));
	...
	private static class LbsHttpBinding extends DefaultHttpBinding {
		...
		public LbsHttpBinding(HttpEndpoint endpoint) {
			super(endpoint);
		}
