 ...
 */
public abstract class EbXMLBaseObjectContainer30 implements EbXMLObjectContainer {
     ...
     */
    EbXMLBaseObjectContainer30(EbXMLObjectLibrary objectLibrary) {
    ...
    public List<EbXMLAssociation> getAssociations() {
        ...
        for (JAXBElement<? extends IdentifiableType> identifiable : getContents()) {
            ...
            if (association != null) {
                results.add(new EbXMLAssociation30(association));
            }
        }
    ...
    public List<EbXMLExtrinsicObject> getExtrinsicObjects(String objectType) {
        ...
        for (JAXBElement<? extends IdentifiableType> identifiable : getContents()) {
            ...
            if (extrinsic != null && objectType.equals(extrinsic.getObjectType())) {
                results.add(new EbXMLExtrinsicObject30(extrinsic));
            }
        }
    ...
    public List<EbXMLRegistryPackage> getRegistryPackages(String classificationNode) {
        ...
        for (JAXBElement<? extends IdentifiableType> identifiable : getContents()) {
            ...
            if (matchesFilter(regPackage, acceptedIds, classificationNode)) {
                results.add(new EbXMLRegistryPackage30(regPackage));
            }
        }
