 ...
 */
public class InternationalString21 implements InternationalString {
    private final static ObjectFactory rimFactory = new ObjectFactory();
    
    private final InternationalStringType international;
    
    private InternationalString21(InternationalStringType international) {
        this.international = international;
    }

    static InternationalString21 create(InternationalStringType international) {
        return new InternationalString21(international);
    }
    
    static InternationalString21 create(LocalizedString localized) {
        if (localized == null) {
            return new InternationalString21(null);
        }
