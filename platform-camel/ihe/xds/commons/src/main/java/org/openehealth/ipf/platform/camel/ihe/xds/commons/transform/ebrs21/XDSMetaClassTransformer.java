...
import static org.openehealth.ipf.platform.camel.ihe.xds.commons.transform.ebrs21.Ebrs21.addExternalIdentifier;
import static org.openehealth.ipf.platform.camel.ihe.xds.commons.transform.ebrs21.Ebrs21.createExternalIdentifiable;
import static org.openehealth.ipf.platform.camel.ihe.xds.commons.transform.ebrs21.Ebrs21.createInternationalString;
import static org.openehealth.ipf.platform.camel.ihe.xds.commons.transform.ebrs21.Ebrs21.getExternalIdentifier;
import static org.openehealth.ipf.platform.camel.ihe.xds.commons.transform.ebrs21.Ebrs21.getSingleLocalizedString;
...
/**
 * Base class for transformers of {@link XDSMetaClass} and ebXML 2.1 representations.
 * @param <E>
 *          the ebXML 2.1 type.
 * @param <C>
 ...
 */
public abstract class XDSMetaClassTransformer<E extends RegistryEntryType, C extends XDSMetaClass> {
    ...
    /**
     * Transforms the given {@link XDSMetaClass} into its ebXML 2.1 representation.
     * @param metaData
     *          the meta data to transform.
     * @return the ebXML 2.1 representation.
     */
    public E toEbXML21(C metaData) {
        if (metaData == null) {
            return null;
        }
    ...
    /**
     * Transforms an ebXML 2.1 representation into its {@link XDSMetaClass}.
     * @param ebXML
     *          the ebXML 2.1 representation.
     * @return the meta data.
     */
    public C fromEbXML21(E ebXML) {
        if (ebXML == null) {
            return null;
        }
