...
public enum ValidationMessage {
    ...
    DOC_ENTRY_PATIENT_ID_WRONG("Document entry and submission set must define the same patient ID"),
    FOLDER_PATIENT_ID_WRONG("Folder and submission set must define the same patient ID"),
