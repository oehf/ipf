...
/**
 * Test framework methods for ebXML 2.1 related classes.
 * @author Jens Riemschneider
 */
public abstract class Ebrs21TestUtils {
    private Ebrs21TestUtils() {
     ...
     *          the expected classified object.
     ...
     */
    public static ClassificationType assertClassification(String scheme, List<ClassificationType> classifications, int occurrence, Object expectedClassifiedObject, String expectedNodeRepresentation, int expectedLocalizedIdxName) {
        List<ClassificationType> filtered = Ebrs21.getClassifications(classifications, scheme);
        assertTrue(filtered.size() > occurrence);

        ClassificationType classification = filtered.get(occurrence);
        assertSame(expectedClassifiedObject, classification.getClassifiedObject());
    ...
    public static LocalizedString toLocal(InternationalStringType international) {
        ...
        return Ebrs21.getSingleLocalizedString(international);
    }
