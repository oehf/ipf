...
public class DocumentEntryTransformerTest {
    ...
    public void testToEbXML30Empty() {
        ExtrinsicObjectType ebXML = transformer.toEbXML30(new DocumentEntry());        
        assertNotNull(ebXML);
        
        assertNull(ebXML.getStatus());
        // ExtrinsicObjectType's MIME Type cannot be null in ebXML 3.0 
    ...
    public void testFromEbXML30Empty() {
        DocumentEntry result = transformer.fromEbXML30(new ExtrinsicObjectType());
        DocumentEntry empty = new DocumentEntry();
        // ExtrinsicObjectType's MIME Type cannot be null in ebXML 3.0 
