...
public class SubmissionSetTransformerTest {
    ...
    public void testToEbXML30() {
        RegistryPackageType ebXML = transformer.toEbXML30(set);        
        assertNotNull(ebXML);
    ...
    public void testToEbXML30Empty() {
        RegistryPackageType ebXML = transformer.toEbXML30(new SubmissionSet());        
        assertNotNull(ebXML);
    ...
    public void testFromEbXML30() {
        RegistryPackageType ebXML = transformer.toEbXML30(set);
        SubmissionSet result = transformer.fromEbXML30(ebXML);
    ...
    public void testFromEbXML30Empty() {
        SubmissionSet result = transformer.fromEbXML30(new RegistryPackageType());
