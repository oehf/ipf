...
![ITI-57 actors](images/iti57.png)
...
The endpoint URI format of `xds-iti57` component producers is:
...
and serviceName equals to `iti57Service`, then the xds-iti57 consumer will be available for external clients under the URL
`http://eHealth.server.org:8888/IHE/xds/iti57Service`
...
```java
from("xds-iti57:iti57Service?audit=true")
  .process(myProcessor)
