...
public class Iti43Component extends XdsComponent<XdsNonconstructiveDocumentSetRequestAuditDataset> {
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) {
        return new XdsEndpoint<>(uri, remaining, this, parameters, Iti43Service.class) {
            @Override
            public AbstractWsProducer<XdsNonconstructiveDocumentSetRequestAuditDataset, ?, ?> getProducer(
                AbstractWsEndpoint<XdsNonconstructiveDocumentSetRequestAuditDataset> endpoint,
