...
public class Iti38Component extends AbstractWsComponent<WsTransactionConfiguration> {
    ...
    public WsAuditStrategy getClientAuditStrategy(boolean allowIncompleteAudit) {
        return new Iti38ClientAuditStrategy(allowIncompleteAudit);
    }

    @Override
    public WsAuditStrategy getServerAuditStrategy(boolean allowIncompleteAudit) {
        return new Iti38ServerAuditStrategy(allowIncompleteAudit);
    }

    @Override
    public Iti38Service getServiceInstance(DefaultItiEndpoint<?> endpoint) {
