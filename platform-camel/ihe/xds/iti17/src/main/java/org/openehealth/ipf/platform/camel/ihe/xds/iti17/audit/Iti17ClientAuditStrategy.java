 ...
 */
package org.openehealth.ipf.platform.camel.ihe.xds.iti17.audit;

import org.openehealth.ipf.platform.camel.ihe.xds.commons.cxf.audit.AuditDataset;
import org.openhealthtools.ihe.atna.auditor.codes.rfc3881.RFC3881EventCodes.RFC3881EventOutcomeCodes;

/**
 * Client audit strategy for ITI-17.
 * 
 * @author Dmytro Rud
 */
public class Iti17ClientAuditStrategy extends Iti17AuditStrategy {
    ...
    public AuditDataset createAuditDataset() {
        return new Iti17AuditDataset(false);
    }
}
