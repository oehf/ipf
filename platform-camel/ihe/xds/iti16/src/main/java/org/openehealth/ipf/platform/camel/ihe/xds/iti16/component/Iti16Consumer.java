...
/**
 * The Camel consumer for the ITI-16 transaction.
 */
public class Iti16Consumer extends DefaultItiConsumer {
    /**
     ...
     */
    public Iti16Consumer(Iti16Endpoint endpoint, Processor processor, ItiServiceInfo<?> serviceInfo) {
        super(endpoint, processor, new Iti16Service(), serviceInfo);
    }
