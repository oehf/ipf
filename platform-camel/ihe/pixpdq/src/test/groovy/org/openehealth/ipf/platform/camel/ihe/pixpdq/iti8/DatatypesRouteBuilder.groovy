...
import static org.openehealth.ipf.platform.camel.ihe.mllp.MllpMarshalUtils.typeSupported
...
class DatatypesRouteBuilder extends SpringRouteBuilder {
     ...
     void configure() throws Exception {
         ...
         from('xds-iti8://0.0.0.0:8087?audit=false')
         ...
         from('xds-iti8://0.0.0.0:8088?audit=false')
             .process {
