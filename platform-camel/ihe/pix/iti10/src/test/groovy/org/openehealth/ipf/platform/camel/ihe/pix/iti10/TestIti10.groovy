...
class TestIti10 extends MllpTestContainer {
    ...
    void testHappyCaseAndAudit1() {
        doTestHappyCaseAndAudit('pix-iti10://localhost:8888', true, 2)
    }
    @Test
    void testHappyCaseAndAudit2() {
        doTestHappyCaseAndAudit('pix-iti10://localhost:8887?audit=false', false, 0)
    }
    ...
    def doTestInacceptanceOnConsumer(String msh9, String msh12) {
        def endpointUri = 'pix-iti10://localhost:8888'
    ...
    void testIncompleteAudit1() throws Exception {
        ...
        doTestIncompleteAudit('pix-iti10://localhost:8886?allowIncompleteAudit=true', 2)
    }
    @Test
    void testIncompleteAudit2() throws Exception {
        // consumer-side only
        doTestIncompleteAudit('pix-iti10://localhost:8886', 1)
    }
    @Test
    void testIncompleteAudit3() throws Exception {
        // producer-side only
        doTestIncompleteAudit('pix-iti10://localhost:8888?allowIncompleteAudit=true', 1)
    }
    @Test
    void testIncompleteAudit4() throws Exception {
        // producer-side only, but fictive
        doTestIncompleteAudit('pix-iti10://localhost:8888?allowIncompleteAudit=true&audit=false', 0)
    }
