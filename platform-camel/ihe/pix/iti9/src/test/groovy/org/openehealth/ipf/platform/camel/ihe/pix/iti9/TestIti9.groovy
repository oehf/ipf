...
class TestIti9 extends MllpTestContainer {
    ...
    void testHappyCaseAndAudit1() {
        doTestHappyCaseAndAudit('pix-iti9://localhost:8888', 2)
    }
    @Test
    void testHappyCaseAndAudit2() {
        doTestHappyCaseAndAudit('pix-iti9://localhost:8887?audit=false', 0)
    }
    ...
    def doTestInacceptanceOnConsumer(String msh9, String msh12) {
        def endpointUri = 'pix-iti9://localhost:8888'
    ...
    void testIncompleteAudit3() throws Exception {
        // producer-side only
        doTestIncompleteAudit('pix-iti9://localhost:8888?allowIncompleteAudit=true', 1)
    }
    @Test
    void testIncompleteAudit4() throws Exception {
        // producer-side only, but fictive
        doTestIncompleteAudit('pix-iti9://localhost:8888?allowIncompleteAudit=true&audit=false', 0)
    }
