...
import org.openehealth.ipf.platform.camel.ihe.xdsb.iti42.audit.Iti42AuditDataset;
 ...
 * @author Dmytro Rud
 */
public class TestIti42AuditFinalInterceptor extends AuditTestFinalInterceptor {

    public TestIti42AuditFinalInterceptor(boolean isServerSide) {
        super(isServerSide);
    }
