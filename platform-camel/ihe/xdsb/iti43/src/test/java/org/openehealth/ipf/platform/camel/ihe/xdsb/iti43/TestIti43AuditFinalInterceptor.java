...
import org.openehealth.ipf.platform.camel.ihe.xdsb.iti43.audit.Iti43AuditDataset;
 ...
 * @author Dmytro Rud
 */
public class TestIti43AuditFinalInterceptor extends AuditTestFinalInterceptor {

    public TestIti43AuditFinalInterceptor(boolean isServerSide) {
        super(isServerSide);
    }
