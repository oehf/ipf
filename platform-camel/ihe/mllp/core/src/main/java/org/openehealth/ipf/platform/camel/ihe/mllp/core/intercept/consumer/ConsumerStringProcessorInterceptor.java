 ...
 * @author Dmytro Rud
 */
public class ConsumerStringProcessorInterceptor extends AbstractMllpInterceptor {

    public ConsumerStringProcessorInterceptor(MllpEndpoint endpoint, Processor wrappedProcessor) {
