...
import static org.openehealth.ipf.platform.camel.ihe.mllp.MllpMarshalUtils.*;
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        while (currentSegmentIndex < segments.size()) {
            ...
            if(currentSegmentIndex < segments.size()) {
                continuationPointer = UUID.randomUUID().toString();
                sb.append("DSC")
            ...
            if(currentSegmentIndex < segments.size()) {
                ...
                mshFields.set(9, UUID.randomUUID().toString());
