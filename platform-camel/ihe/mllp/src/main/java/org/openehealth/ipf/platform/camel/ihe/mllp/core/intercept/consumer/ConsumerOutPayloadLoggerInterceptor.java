 ...
 * @author Dmytro Rud
 */
public class ConsumerOutPayloadLoggerInterceptor extends InterceptorSupport {
    ...
    public static class Factory extends InterceptorFactorySupport<ConsumerOutPayloadLoggerInterceptor> {
