...
public class NakFactory {
     ...
     */
    public NakFactory(MllpTransactionConfiguration config, boolean useCAckTypeCodes, String defaultNakMsh9) {
     ...
     *      Configuration of the transaction served by this factory.
     */
    public NakFactory(MllpTransactionConfiguration config) {
     ...
     */
    protected MllpTransactionConfiguration getConfig() {
        return config;
    }
