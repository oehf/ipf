...
public class TestIti8 {
    ...
    private void doTestHappyCaseAndAudit(String endpointUri, int expectedPacketCount) throws Exception {
        ...
        MessageAdapter msg = Exchanges.resultMessage(send(endpointUri, body)).getBody(MessageAdapter.class);
    ...
    public void testInacceptanceOnConsumer() throws Exception {
        ...
        doTestInacceptanceOnConsumer("ADT^A01", "3.1415924", processor);
    }
     ...
     */
    @Test
    public void checkAlterativeHl7CodecFactory() {
    ...
    private Exchange send(String endpoint, String body) {        
        Exchange exchange = new DefaultExchange(camelContext);
        exchange.getIn().setBody(body);
