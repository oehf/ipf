 ...
 * @author Dmytro Rud
 */
public class Iti55DeferredResponseProducer extends AbstractWsProducer<Hl7v3AuditDataset, String, String> {

    public Iti55DeferredResponseProducer(AbstractWsEndpoint<Hl7v3AuditDataset> endpoint,
