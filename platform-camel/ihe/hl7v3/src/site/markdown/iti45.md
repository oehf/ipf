...
![ITI-45 actors](images/iti45.png)
...
The endpoint URI format of `pixv3-iti45` component producers is:

```
pixv3-iti45://hostname:port/path/to/service[?parameters]
```
...
The endpoint URI format of `pixv3-iti45` component consumers is:

```
pixv3-iti45:serviceName[?parameters]
```
...
and serviceName equals to `iti45Service`, then the pixv3-iti45 consumer will be available for external clients under the URL
`http://eHealth.server.org:8888/IHE/pixv3/iti45Service`
...
```java
from("pixv3-iti45:iti45Service?audit=true")
  .process(myProcessor)
