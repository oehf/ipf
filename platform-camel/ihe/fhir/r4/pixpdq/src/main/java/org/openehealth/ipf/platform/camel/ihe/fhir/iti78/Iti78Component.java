...
import static org.openehealth.ipf.commons.ihe.fhir.pixpdq.PDQM.Interactions.ITI_78;
...
public class Iti78Component extends FhirComponent<FhirQueryAuditDataset> {
    ...
    @Override
    protected Iti78Endpoint doCreateEndpoint(String uri, FhirEndpointConfiguration config) {
