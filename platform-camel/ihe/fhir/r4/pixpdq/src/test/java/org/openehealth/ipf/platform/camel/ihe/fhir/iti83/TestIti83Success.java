...
public class TestIti83Success extends AbstractTestIti83 {
    ...
    public void testGetConformance() {
        ...
        CapabilityStatementRestResourceOperationComponent operation = component.getResource().stream()
    ...
    public void testSendManualPixm() {
        ...
        assertEquals("sourceIdentifier=urn:oid:1.2.3.4|0815&targetSystem=urn:oid:1.2.3.4.6&_format=xml",
