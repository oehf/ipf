...
public class TestIti66Success extends AbstractTestIti66 {
    ...
    public void testSendManualIti66() {
        ...
        assertEquals("http://localhost:" + DEMO_APP_PORT + "/List", destination.getUserID());
    ...
    public void testGetResource() {
        var p = client.read()
                ...
                .execute();
        assertEquals(String.format("http://localhost:%d/List/9bc72458-49b0-11e6-8a1c-3c1620524153", DEMO_APP_PORT), p.getId());
    }
