...
public class TestIti66MissingParameter extends AbstractTestIti66 {
    ...
    private static final String CONTEXT_DESCRIPTOR = "v421/iti-66-error.xml";
    ...
    public void testSendManuallyReturningError() {
        assertThrows(InvalidRequestException.class, ()-> sendManually(listPatientIdentifierMissingParameter()));
    }
