...
public class ChPpq3Endpoint extends FhirEndpoint<ChPpqmAuditDataset> {

    public ChPpq3Endpoint(String uri, ChPpq3Component fhirComponent, FhirEndpointConfiguration config) {
