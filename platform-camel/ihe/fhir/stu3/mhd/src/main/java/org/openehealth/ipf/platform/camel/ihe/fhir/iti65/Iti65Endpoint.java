 ...
 * @since 3.4
 */
public class Iti65Endpoint extends FhirEndpoint<Iti65AuditDataset> {

    public Iti65Endpoint(String uri, Iti65Component fhirComponent, FhirEndpointConfiguration config) {
