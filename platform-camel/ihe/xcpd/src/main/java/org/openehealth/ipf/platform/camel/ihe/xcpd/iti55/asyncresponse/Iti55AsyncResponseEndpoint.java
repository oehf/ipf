...
import org.openehealth.ipf.commons.ihe.xcpd.iti55.asyncresponse.Iti55AsyncResponse;
 ...
 */
public class Iti55AsyncResponseEndpoint extends AsynchronousItiEndpoint /*DefaultItiEndpoint*/ {
    /**
    ...
    public Iti55AsyncResponseEndpoint(
            String endpointUri, 
            String address, 
            Iti55AsyncResponseComponent iti55AsyncResponseComponent) throws URISyntaxException 
    {
        super(endpointUri, address, iti55AsyncResponseComponent);
    }
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        ItiServiceFactory serviceFactory = 
            Iti55AsyncResponse.getServiceFactory(
                    isAudit(), 
