...
public class Ech0213Component extends AbstractWsComponent<WsAuditDataset> {
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) {
        return new EchEndpoint(uri, remaining, this, parameters, Ech0213Service.class) {
            @Override
            public AbstractWsProducer<WsAuditDataset, ?, ?> getProducer(AbstractWsEndpoint<WsAuditDataset> endpoint,
