...
public class Splitter extends DelegateProcessor {
     ...
     * @param origExchange
     *          exchange that should be split by this processor
     */
    @Override
     ...
     * 
     * @param origExchange
     *          the exchange that was originally passed to {@link #process(Exchange)}.
     ...
     * 
     * @param origExchange
     *          original exchange passed to {@link #process(Exchange)}
     * @param subExchange
