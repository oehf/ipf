...
import org.openehealth.ipf.platform.manager.flowmanager.ui.jobs.ReplayFlowJob;
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (editor instanceof FlowManagerEditor) {
            ...
            if (selection != null) {
                ...
                ReplayFlowJob replayFlowJob = new ReplayFlowJob(Display.getCurrent(),
                        connectionConfiguration, flowInfos);
