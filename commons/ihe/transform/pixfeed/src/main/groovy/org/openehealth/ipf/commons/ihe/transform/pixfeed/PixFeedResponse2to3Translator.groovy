 ...
 */
class PixFeedResponse2to3Translator implements Hl72to3ResponseTranslator {

	/**
	 * First character of the acknowledgement code.  Possible values are 'A' and 'C'.
	 * <p>
     ...
     */
    String translateResponse(MessageAdapter rsp, String originalMessage) {    
