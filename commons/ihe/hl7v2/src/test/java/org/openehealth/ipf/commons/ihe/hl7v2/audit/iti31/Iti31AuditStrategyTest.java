 ...
 */
public class Iti31AuditStrategyTest extends Hl7v2AuditorTestBase {
    ...
    @Test
    public void testDeleteServerSide() {
        testRequest(true, EventActionCode.Delete);
    }

    @Test
    public void testDeleteClientSide() {
        testRequest(false, EventActionCode.Delete);
    }

    private void testRequest(boolean serverSide, EventActionCode eventActionCode) {
        Iti31AuditStrategy strategy = new Iti31AuditStrategy(serverSide);
    ...
    private FeedAuditDataset getHl7v2AuditDataset(Iti31AuditStrategy strategy, EventActionCode eventActionCode) {
        ...
        switch (eventActionCode) {
            ...
            case Delete: auditDataset.setMessageType("A41"); break;
        }
