...
public class RSP_K21Test {
	...
	public void testGetQUERY_RESPONSE(){
		...
		RSP_K21_QUERY_RESPONSE response = msg.getRSP_K21_QUERY_RESPONSE();
	...
	public void testGetRSP_K21_QUERY_RESPONSEReps(){
		RSP_K21 msg = new RSP_K21();
		assertEquals(0 , msg.getRSP_K21_QUERY_RESPONSEReps());
	}
	
	@Test
	public void testGetRSP_K21_QUERY_RESPONSERepsWithParams() throws Exception {
		RSP_K21 msg = new RSP_K21();
		RSP_K21_QUERY_RESPONSE response = msg.getRSP_K21_QUERY_RESPONSE(0);
		assertNotNull (response);
		response = msg.getRSP_K21_QUERY_RESPONSE(1);
		assertNotNull (response);
	}
}
