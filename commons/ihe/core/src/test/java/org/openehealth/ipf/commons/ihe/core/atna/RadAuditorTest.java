...
public class RadAuditorTest extends TestCase {
    ...
    private static final String[] DOCUMENT_UUIDS        = {"document_uuid1","document_uuid2","document_uuid3"};
    private static final String[] REPOSITORY_UUIDS      = {"repository_uuid1","repository_uuid2","repository_uuid3"};
    private static final String[] HOME_COMMUNITY_UUIDS  = {"home-community_uuid1","home-community_uuid2","home-community_uuid3"};
