...
import org.openehealth.ipf.commons.ihe.ws.cxf.payload.StringPayloadHolder.PayloadType
...
class InPayloadLoggerInterceptor extends AbstractSafeInterceptor {
    ...
    InPayloadLoggerInterceptor(String fileNamePattern) {
        super(Phase.RECEIVE)
        addAfter(AttachmentInInterceptor.class.name)
    ...
    Collection<PhaseInterceptor<? extends Message>> getAdditionalInterceptors() {
        return [new InPayloadExtractorInterceptor(PayloadType.HTTP)]
    }
