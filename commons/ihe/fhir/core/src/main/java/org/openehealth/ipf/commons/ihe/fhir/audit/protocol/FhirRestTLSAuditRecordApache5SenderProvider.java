...
public class FhirRestTLSAuditRecordApache5SenderProvider implements AuditTransmissionProtocolProvider {

    @Override
    public AuditTransmissionProtocol createAuditTransmissionProtocol(TlsParameters tlsParameters) {
        return new Apache5FhirRestTLSAuditRecordSender(tlsParameters);
    }
}
