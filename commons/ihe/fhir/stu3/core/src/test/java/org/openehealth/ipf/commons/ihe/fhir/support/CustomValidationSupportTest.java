...
public class CustomValidationSupportTest {
    ...
    public void testFindStructureDefinition() {
        CustomValidationSupport customValidationSupport = new CustomValidationSupport(FHIR_CONTEXT);
        customValidationSupport.setPrefix("profiles/MHD-");
        StructureDefinition definition = customValidationSupport.fetchResource(StructureDefinition.class,
