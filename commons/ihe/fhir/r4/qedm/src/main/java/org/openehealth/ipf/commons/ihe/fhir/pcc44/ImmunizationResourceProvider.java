...
public class ImmunizationResourceProvider extends AbstractPcc44ResourceProvider<Immunization> {
    ...
    public IBundleProvider search(
            @RequiredParam(name = Immunization.SP_PATIENT) ReferenceParam patient,
            // Extension
        ...
        // Run down the route
        return requestBundleProvider(null, parameters, ResourceType.Immunization.name(), httpServletRequest, httpServletResponse);
    }
