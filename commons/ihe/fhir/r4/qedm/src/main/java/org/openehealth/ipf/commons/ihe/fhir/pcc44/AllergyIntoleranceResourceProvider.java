...
public class AllergyIntoleranceResourceProvider extends AbstractPcc44ResourceProvider<AllergyIntolerance> {
    ...
    public IBundleProvider search(
            @RequiredParam(name = AllergyIntolerance.SP_PATIENT) ReferenceParam patient,
            // Extension
        ...
        // Run down the route
        return requestBundleProvider(null, parameters, ResourceType.AllergyIntolerance.name(), httpServletRequest, httpServletResponse);
    }
