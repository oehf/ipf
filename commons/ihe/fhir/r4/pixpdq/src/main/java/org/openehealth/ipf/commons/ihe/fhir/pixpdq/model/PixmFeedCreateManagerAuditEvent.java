 ...
 * reference Manager, i.e. the server of the transaction, for a patient that has been created. PIXm
 * profiles it on the BALP PatientCreate pattern, adding the IHE transaction subtype.
 *
...
@ResourceDef(
    name = "AuditEvent",
    id = "PixmFeedCreateManagerAuditEvent",
    profile = PixmProfile.PIXM_FEED_CREATE_MANAGER_AUDIT_PROFILE)
public class PixmFeedCreateManagerAuditEvent extends PatientCreateAuditEvent {

    public PixmFeedCreateManagerAuditEvent() {
        super();
