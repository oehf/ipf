...
/**
 * The AuditEvent an ITI-78 audit record takes when it is written by the Patient Demographics Supplier,
...
@ResourceDef(
    name = "AuditEvent",
    id = "PdqmSupplierAuditEvent",
    profile = PdqmProfile.PDQM_SUPPLIER_AUDIT_PROFILE)
public class PdqmSupplierAuditEvent extends PdqmAuditEvent {
