...
/**
 * The AuditEvent an ITI-119 audit record takes when it is written by the Patient Demographics Consumer,
...
@ResourceDef(
    name = "AuditEvent",
    id = "PdqmMatchConsumerAuditEvent",
    profile = PdqmProfile.PDQM_MATCH_CONSUMER_AUDIT_PROFILE)
public class PdqmMatchConsumerAuditEvent extends PdqmMatchAuditEvent {
