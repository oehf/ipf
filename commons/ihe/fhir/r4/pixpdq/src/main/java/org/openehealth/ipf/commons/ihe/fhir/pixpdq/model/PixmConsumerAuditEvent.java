...
/**
 * The AuditEvent an ITI-83 audit record takes when it is written by the Patient Identifier
 * Cross-reference Consumer, i.e. the client of the transaction.
 *
...
@ResourceDef(
    name = "AuditEvent",
    id = "PixmConsumerAuditEvent",
    profile = PixmProfile.PIXM_CONSUMER_AUDIT_PROFILE)
public class PixmConsumerAuditEvent extends PixmAuditEvent {
