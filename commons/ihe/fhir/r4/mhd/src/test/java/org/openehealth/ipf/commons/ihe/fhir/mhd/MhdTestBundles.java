...
/**
 * Fully populated MHD resources, shared by the tests that need something valid to validate.
 *
 * @author Christian Ohr
 */
final class MhdTestBundles {

    static final String BINARY_FULL_URL = "urn:uuid:8da1cfcc-05db-4aca-86ad-82aa756a64bb";
    static final String REFERENCE_FULL_URL = "urn:uuid:8da1cfcc-05db-4aca-86ad-82aa756a64bc";
    static final String MANIFEST_FULL_URL = "urn:uuid:8da1cfcc-05db-4aca-86ad-82aa756a64bd";

    private MhdTestBundles() {
    }

    static ComprehensiveProvideDocumentBundle provideAndRegister() throws Exception {
