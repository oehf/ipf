...
/**
 * The AuditEvent an ITI-68 audit record takes when it is written by the Document Responder, i.e. the
...
@ResourceDef(
    name = "AuditEvent",
    id = "RetrieveDocumentResponderAuditEvent",
    profile = MhdProfile.RETRIEVE_DOCUMENT_RESPONDER_AUDIT_PROFILE)
public class RetrieveDocumentResponderAuditEvent extends RetrieveDocumentAuditEvent {
