...
/**
 * The AuditEvent an ITI-68 audit record takes when it is written by the Document Consumer, i.e. the
...
@ResourceDef(
    name = "AuditEvent",
    id = "RetrieveDocumentConsumerAuditEvent",
    profile = MhdProfile.RETRIEVE_DOCUMENT_CONSUMER_AUDIT_PROFILE)
public class RetrieveDocumentConsumerAuditEvent extends RetrieveDocumentAuditEvent {
