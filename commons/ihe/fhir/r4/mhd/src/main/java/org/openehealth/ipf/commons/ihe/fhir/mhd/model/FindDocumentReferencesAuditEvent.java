...
abstract class FindDocumentReferencesAuditEvent extends PatientQueryAuditEvent implements SelfInitializing {

    public FindDocumentReferencesAuditEvent() {
        super();
        addSubtype()
            .setCode(MobileDocumentReferenceQuery.getCode())
            .setSystem(MobileDocumentReferenceQuery.getCodeSystemName())
            .setDisplay(MobileDocumentReferenceQuery.getDisplayName());
    }
