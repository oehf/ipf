...
/**
 * The AuditEvent of the Simplified Publish [ITI-105] transaction, which MHD profiles on the BALP
 * PatientCreate pattern.
 * <p>
...
abstract class SimplifiedPublishAuditEvent extends SelfInitializingCreateAuditEvent {
    ...
    protected SimplifiedPublishAuditEvent() {
        super();
        addTransactionSubtype(SimplifiedPublish);
    }
}
