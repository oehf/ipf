...
/**
 * The AuditEvent an ITI-65 audit record takes when it is written by the Document Recipient, i.e. the
...
@ResourceDef(
    name = "AuditEvent",
    id = "ProvideBundleRecipientAuditEvent",
    profile = MhdProfile.PROVIDE_BUNDLE_RECIPIENT_AUDIT_PROFILE)
public class ProvideBundleRecipientAuditEvent extends ProvideBundleAuditEvent {
