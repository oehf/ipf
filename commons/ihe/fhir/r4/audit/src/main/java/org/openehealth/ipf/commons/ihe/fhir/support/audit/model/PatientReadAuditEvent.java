...
import static org.openehealth.ipf.commons.ihe.fhir.support.audit.model.BalpConstants.BALP_PATIENT_READ_AUDIT_PROFILE;

@ResourceDef(name = "AuditEvent", id = "PatientReadAuditEvent", profile = BALP_PATIENT_READ_AUDIT_PROFILE)
public class PatientReadAuditEvent extends ReadAuditEvent {
    ...
    public PatientReadAuditEvent setPatient(Reference patientReference) {
