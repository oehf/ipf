...
/**
 * The AuditEvent the receiving side of a privacy disclosure records. The two ends of the disclosure are
...
public class ImportAuditEvent extends BalpAuditEvent {
    ...
    public ImportAuditEvent() {
        ...
        setType(new Coding()
            ...
            .setDisplay(Import.getOriginalText()));
        addSubtype()
     ...
     * @return the receiving side, which occupies the recipient slot of the disclosure. Unlike the RESTful patterns, which end recorded
     ...
     * @return this instance
     */
    public ImportAuditEvent setSource(ActiveParticipantType source) {
     ...
     * @return this instance
     */
    public ImportAuditEvent setRecipient(ActiveParticipantType recipient) {
    ...
    /**
     * Sets an entity for the imported data
     *
     * @param entity what was imported (can be display only)
