...
import static org.openehealth.ipf.commons.ihe.fhir.support.audit.model.BalpConstants.BALP_PATIENT_UPDATE_AUDIT_PROFILE;

@ResourceDef(name = "AuditEvent", id = "PatientUpdateAuditEvent", profile = BALP_PATIENT_UPDATE_AUDIT_PROFILE)
public class PatientUpdateAuditEvent extends UpdateAuditEvent {
     ...
     */
    public PatientUpdateAuditEvent setPatient(Reference patientReference) {
