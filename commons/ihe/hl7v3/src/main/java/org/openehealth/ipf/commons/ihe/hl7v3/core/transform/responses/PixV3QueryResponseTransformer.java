...
public class PixV3QueryResponseTransformer {
    ...
    public PRPAIN201310UV02Type toPrpa(final PixV3QueryResponse simpleResponse) {
        ...
        final var response = new PRPAIN201310UV02Type();
        ...
        final var acknowledgement = new MCCIMT000300UV01Acknowledgement();
        ...
        final var queryAck = new MFMIMT700711UV01QueryAck();
        ...
        for (final var dataSourceOid : simpleResponse.getDataSourceOids()) {
        ...
        final var subject = new PRPAIN201310UV02MFMIMT700711UV01Subject1();
        ...
        final var subject1 = new PRPAIN201310UV02MFMIMT700711UV01Subject2();
        ...
        final var person = new PRPAMT201304UV02Person();
        ...
        final var custodian = new MFMIMT700711UV01Custodian();
    ...
    public PixV3QueryResponse fromPrpa(final PRPAIN201310UV02Type response) {
        ...
        final var simpleResponse = new PixV3QueryResponse();
        ...
        if (!response.getAcknowledgement().isEmpty()) {
            final var acknowledgement = response.getAcknowledgement().get(0);
        ...
        final var controlActProcess = response.getControlActProcess();
        ...
        final var queryAck = controlActProcess.getQueryAck();
        if (queryAck != null) {
    ...
    private MCCIMT000300UV01Receiver toReceiver(final Device simpleDevice) {
        ...
        final var receiver = new MCCIMT000300UV01Receiver();
        receiver.setTypeCode(CommunicationFunctionType.RCV);
        receiver.setTelecom(simpleDevice.getTelecom());
        final var device = new MCCIMT000300UV01Device();
    ...
    private MCCIMT000300UV01Sender toSender(final Device simpleDevice) {
        ...
        final var sender = new MCCIMT000300UV01Sender();
