 ...
 * @author Dmytro Rud
 */
public class Hl7v3Validator implements Validator<String, String[][]> {
     ...
     */
    @Override
    public void validate(String message, String[][] profiles) throws ValidationException {
        ...
        String[] profile = null;
        for (String[] list : profiles) {
            if (list[0].equals(rootElementName)) {
                profile = list;
                break;
            }
        }
