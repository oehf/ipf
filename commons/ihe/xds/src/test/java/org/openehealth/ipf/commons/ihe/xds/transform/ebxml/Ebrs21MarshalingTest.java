...
import org.openehealth.ipf.commons.ihe.xds.ebxml.ebxml21.EbXMLExtrinsicObject21;
...
import org.openehealth.ipf.commons.ihe.xds.metadata.Code;
import org.openehealth.ipf.commons.ihe.xds.metadata.DocumentEntry;
import org.openehealth.ipf.commons.ihe.xds.metadata.Folder;
...
import org.openehealth.ipf.commons.ihe.xds.stub.ebrs21.rim.RegistryEntryType;
...
public class Ebrs21MarshalingTest {
    ...
    private SubmitObjectsRequest send() throws JAXBException {
        JAXBContext context = JAXBContext.newInstance("org.openehealth.ipf.commons.ihe.xds.stub.ebrs21.rs");
