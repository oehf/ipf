 ...
 * @since 3.7
 */
public class FindPrescriptionsForValidationQueryTransformerTest extends AbstractQueryTransformerTest<FindPrescriptionsForValidationQuery, FindPrescriptionsForValidationQueryTransformer> {

    @BeforeEach
    public void setUp() {
        transformer = FindPrescriptionsForValidationQueryTransformer.getInstance();
    ...
    @Override
    protected FindPrescriptionsForValidationQuery emptyQuery() {
        return new FindPrescriptionsForValidationQuery();
    }
}
