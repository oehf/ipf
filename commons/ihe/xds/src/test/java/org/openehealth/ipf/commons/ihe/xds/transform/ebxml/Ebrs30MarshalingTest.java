...
import org.openehealth.ipf.commons.ihe.xds.ebxml.ebxml30.EbXMLExtrinsicObject30;
...
public class Ebrs30MarshalingTest {
    ...
    private SubmitObjectsRequest send() throws JAXBException {
        JAXBContext context = JAXBContext.newInstance("org.openehealth.ipf.commons.ihe.xds.stub.ebrs30.rs");
