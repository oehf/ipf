...
import org.openehealth.ipf.commons.ihe.xds.core.stub.stub.ebrs21.rim.RegistryEntryType;
...
public class Ebrs21MarshalingTest {
    ...
    private SubmitObjectsRequest send() throws JAXBException {
        JAXBContext context = JAXBContext.newInstance("org.openehealth.ipf.commons.ihe.xds.core.stub.stub.ebrs21.rs");
