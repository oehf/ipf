...
import org.openehealth.ipf.commons.ihe.xds.core.stub.stub.ebrs30.rim.IdentifiableType;
...
public class Ebrs30MarshalingTest {
    ...
    private SubmitObjectsRequest send() throws JAXBException {
        JAXBContext context = JAXBContext.newInstance("org.openehealth.ipf.commons.ihe.xds.core.stub.stub.ebrs30.rs");
