...
/**
 * Server audit strategy for RAD-69.
 * @author Clay Sebourn
 */
public class Rad69ServerAuditStrategy extends Rad69AuditStrategy {
    ...
    public Rad69ServerAuditStrategy(boolean allowIncompleteAudit) {
        super(true, allowIncompleteAudit);
    }

    @Override
    public void doAudit(Rad69AuditDataset auditDataset) {
        AuditorManager.getCustomRadAuditor().auditRetrieveImagingDocumentSetEvent(
