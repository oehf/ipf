...
public class AssociationTypeFactory30 extends XdsEnumFactory<AssociationType> {

    @Override
    public AssociationType[] getOfficialValues() {
        return AssociationType.OFFICIAL_VALUES;
    }
    ...
    @Override
    public String getEbXML(AssociationType code) {
