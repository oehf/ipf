...
@XmlType(name = "", propOrder = {
    "objectRefOrRegistryObjectOrAssociation"
})
@XmlRootElement(name = "AssociationQueryResult")
public class AssociationQueryResult {

    @XmlElements({
        @XmlElement(name = "ObjectRef", namespace = "urn:oasis:names:tc:ebxml-regrep:rim:xsd:2.1", type = ObjectRefType.class),
        @XmlElement(name = "Association", namespace = "urn:oasis:names:tc:ebxml-regrep:rim:xsd:2.1", type = AssociationType1 .class),
        @XmlElement(name = "RegistryObject", namespace = "urn:oasis:names:tc:ebxml-regrep:rim:xsd:2.1", type = RegistryObjectType.class)
    })
    protected List<Object> objectRefOrRegistryObjectOrAssociation;
     ...
     * This is why there is not a <CODE>set</CODE> method for the objectRefOrRegistryObjectOrAssociation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getObjectRefOrRegistryObjectOrAssociation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
