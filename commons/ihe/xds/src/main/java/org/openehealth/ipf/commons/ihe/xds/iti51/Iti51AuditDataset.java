...
/**
 * ITI-51 specific Audit Dataset.
 * @author Dmytro Rud
 * @author Michael Ottati
 */
public class Iti51AuditDataset extends XdsAuditDataset {
    private static final long serialVersionUID = -7456923109145726632L;
     ...
     *            <code>false</code>)
     */
    public Iti51AuditDataset(boolean serverSide) {
        super(serverSide);
    }
