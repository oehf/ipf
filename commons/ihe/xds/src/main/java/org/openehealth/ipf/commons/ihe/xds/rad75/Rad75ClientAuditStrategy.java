...
/**
 * Client audit strategy for RAD-75.
 * @author Clay Sebourn
 */
public class Rad75ClientAuditStrategy extends Rad69AuditStrategy {
    ...
    public Rad75ClientAuditStrategy(boolean allowIncompleteAudit) {
