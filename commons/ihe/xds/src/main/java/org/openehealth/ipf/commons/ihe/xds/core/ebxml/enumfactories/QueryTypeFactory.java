...
public class QueryTypeFactory extends XdsEnumFactory<QueryType> {

    @Override
    public QueryType[] getOfficialValues() {
        return QueryType.OFFICIAL_VALUES;
    }
    ...
    @Override
    public String getEbXML(QueryType code) {
