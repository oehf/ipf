...
import org.openehealth.ipf.commons.ihe.xds.stub.ebrs21.rim.AuditableEventType;
...
@XmlType(name = "", propOrder = {
    "objectRefOrRegistryObjectOrAuditableEvent"
})
@XmlRootElement(name = "AuditableEventQueryResult")
public class AuditableEventQueryResult {

    @XmlElements({
        @XmlElement(name = "AuditableEvent", namespace = "urn:oasis:names:tc:ebxml-regrep:rim:xsd:2.1", type = AuditableEventType.class),
    ...
    protected List<Object> objectRefOrRegistryObjectOrAuditableEvent;
     ...
     * This is why there is not a <CODE>set</CODE> method for the objectRefOrRegistryObjectOrAuditableEvent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getObjectRefOrRegistryObjectOrAuditableEvent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
