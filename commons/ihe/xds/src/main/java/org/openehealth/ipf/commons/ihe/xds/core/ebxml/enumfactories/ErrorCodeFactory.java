...
public class ErrorCodeFactory extends XdsEnumFactory<ErrorCode> {

    @Override
    public ErrorCode[] getOfficialValues() {
        return ErrorCode.OFFICIAL_VALUES;
    }
    ...
    @Override
    public String getEbXML(ErrorCode code) {
