...
import org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.query.AdhocQueryResponse;
import org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.query.ResponseOptionType;
import org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.rim.AdhocQueryType;
import org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.rim.AssociationType1;
...
import org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.rim.RegistryPackageType;
...
public class EbXMLFactory30 implements EbXMLFactory {
     ...
     */
    public final static org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.query.ObjectFactory QUERY_FACTORY = 
        new org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.query.ObjectFactory();

    /**
     * The factory to create objects of the rim namespace.
     */
    public final static org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.rim.ObjectFactory RIM_FACTORY = 
        new org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.rim.ObjectFactory();

    /**
     * The factory to create objects of the rs namespace.
     */
    public final static org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.rs.ObjectFactory RS_FACTORY = 
        new org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.rs.ObjectFactory();

    /**
     * The factory to create objects of the lcm namespace.
     */
    public final static org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.lcm.ObjectFactory LCM_FACTORY = 
        new org.openehealth.ipf.commons.ihe.xds.model.stub.ebrs30.lcm.ObjectFactory();
