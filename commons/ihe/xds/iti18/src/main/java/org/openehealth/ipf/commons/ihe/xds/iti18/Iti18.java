...
/**
 * Provides access to the service and client factories for Xds-18.
...
public class Iti18 {
    ...
    public static XdsClientFactory getClientFactory(boolean soap11, boolean audit, boolean allowIncompleteAudit, String serviceUrl) {        
        return new XdsClientFactory(ITI_18, soap11, audit ? new Iti18ClientAuditStrategy(allowIncompleteAudit) : null, serviceUrl);
    }
    ...
    public static XdsServiceFactory getServiceFactory(boolean audit, boolean allowIncompleteAudit, String serviceAddress) {
        return new XdsServiceFactory(ITI_18, audit ? new Iti18ServerAuditStrategy(allowIncompleteAudit) : null, serviceAddress);
    }
}
