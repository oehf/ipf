/**
 * RegisteredNurseHIPAA.java
 *
 * File generated from the voc::RegisteredNurseHIPAA uml Enumeration
...
@XmlType(name = "RegisteredNurseHIPAA")
@XmlEnum
@XmlRootElement(name = "RegisteredNurseHIPAA")
public enum RegisteredNurseHIPAA {
    ...
    public static RegisteredNurseHIPAA fromValue(String v) {
        for (RegisteredNurseHIPAA c: RegisteredNurseHIPAA.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
