/**
 * RegisteredNurseProviderCodes.java
 * <p>
 * File generated from the voc::RegisteredNurseProviderCodes uml Enumeration
...
public enum RegisteredNurseProviderCodes {
    ...
    RegisteredNurseProviderCodes(String v) {
        value = v;
    }
    ...
    public static RegisteredNurseProviderCodes fromValue(String v) {
        for (RegisteredNurseProviderCodes c: RegisteredNurseProviderCodes.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
