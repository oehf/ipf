/**
 * PersonalRelationshipRoleType.java
 * <p>
 * File generated from the voc::PersonalRelationshipRoleType uml Enumeration
...
@XmlType(name = "PersonalRelationshipRoleType")
@XmlEnum
@XmlRootElement(name = "PersonalRelationshipRoleType")
public enum PersonalRelationshipRoleType {
	@XmlEnumValue("AUNT")
	AUNT("AUNT"),
	@XmlEnumValue("BRO")
	BRO("BRO"),
    ...
    PersonalRelationshipRoleType(String v) {
        value = v;
    }
    ...
    public static PersonalRelationshipRoleType fromValue(String v) {
        for (PersonalRelationshipRoleType c: PersonalRelationshipRoleType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
