/**
 * PodiatristProviderCodes.java
 *
 * File generated from the voc::PodiatristProviderCodes uml Enumeration
...
public enum PodiatristProviderCodes {
    ...
    PodiatristProviderCodes(String v) {
        value = v;
    }
    ...
    public static PodiatristProviderCodes fromValue(String v) {
        for (PodiatristProviderCodes c: PodiatristProviderCodes.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
