...
public interface Iti79PortType {

    @WebMethod(operationName = "AuthorizationDecisionsManager_AuthorizationDecisionsQuery")
    @Action(input = "urn:ihe:iti:2014:ser:XACMLAuthorizationDecisionQueryRequest", output = "urn:ihe:iti:2014:ser:XACMLAuthorizationDecisionQueryResponse")
