 ...
 * @deprecated as of 6.0, use {@link Mappings}, which is {@link String}-typed, returns
 * {@link java.util.Optional} rather than {@code null}, and has neither of the two string
 * conventions this interface's implementations carry. Scheduled for removal in IPF 7.0.
 */
