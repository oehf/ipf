...
/**
 * The Spring wiring - {@link SpringBidiMappingService}, {@link CustomMappings} and the configurer
 * that collects them - is format-agnostic: a resource is dispatched to a loader by its file
 * extension, so an application can add mappings in whichever format suits each file, including
 * several formats in one list.
 */
...
public class MixedFormatMappingsTest {
     ...
     * bean property, which is applied before the configurer adds any resource.
     */
    @Test
