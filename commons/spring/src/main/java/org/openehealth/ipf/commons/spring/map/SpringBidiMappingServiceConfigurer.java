 ...
 * {@link SpringMappings} with its {@code mappingResources} property, or declare
 * {@link org.openehealth.ipf.commons.spring.map.config.CustomMappings} beans, which it collects
 * from the application context by itself.
 */
